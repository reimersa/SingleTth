...
if "18" in year: pileupfileData = "2018/MyDataPileupHistogram2018.root"

btagcalibfile = "2016/DeepJet_2016LegacySF_WP_V1.csv"
if "17" in year: btagcalibfile = "2017/DeepFlavour_94XSF_WP_V3_B_F.csv"
if "18" in year: btagcalibfile = "2018/DeepJet_102XSF_WP_V1.csv"

lumi = 35920
if "17" in year: lumi = "41530"
if "18" in year: lumi = "59740"
...
if "2018" in year:
    out.write(' 		<Item Name="pileup_directory_data_up" Value="/nfs/dust/cms/user/reimersa/CMSSW_10_2_X_v1/CMSSW_10_2_10/src/UHH2/common/data/'+year+'/MyDataPileupHistogram'+year+'_72383.root" /> \n') 
    out.write(' 		<Item Name="pileup_directory_data_down" Value="/nfs/dust/cms/user/reimersa/CMSSW_10_2_X_v1/CMSSW_10_2_10/src/UHH2/common/data/'+year+'/MyDataPileupHistogram'+year+'_66017.root" /> \n') 
else:
