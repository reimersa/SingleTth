...
eval "combine -M GoodnessOfFit -d Datacard_"$year"_M${mass}.txt --setParameters ${set_param} --freezeParameters ${freeze_param} --algo=saturated -t ${ntoys}  --fixedSignalStrength=0  -n GOFfixedR_toys_M${mass}_MA${MA}" # normal version --seed 8192

echo "============================================"


eval "combine -M GoodnessOfFit -d Datacard_"$year"_M${mass}.txt --setParameters ${set_param} --freezeParameters ${freeze_param} --algo=saturated --saveWorkspace --fixedSignalStrength=0 -n GOFfixedR_data_M${mass}_MA${MA}" # normal version --seed 8192
