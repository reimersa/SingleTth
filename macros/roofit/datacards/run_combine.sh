...
#    eval "combine -M AsymptoticLimits -d Datacard_M$mass.txt -t -1 -n output_$mass --setParameters pdf_index_much=0,pdf_index_ech=0 --freezeParameters pdf_index_much,pdf_index_ech"
    eval "combine -M AsymptoticLimits -d Datacard_M$mass.txt -t -1 -n output_$mass --setParameters pdf_index_much=2,pdf_index_ech=2 --freezeParameters pdf_index_much,pdf_index_ech"
