...
eval "combine $datacard -M FitDiagnostics  --setParameters ${set_param}   --freezeParameters  ${freeze_param}  -n individualfit --saveWorkspace --saveShapes  --cminDefaultMinimizerStrategy=2  --cminFallbackAlgo Minuit2,Simplex,0:0.1" 
