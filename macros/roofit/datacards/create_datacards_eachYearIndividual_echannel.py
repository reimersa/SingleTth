...
# open file to write
for mass in masses:
    outputfile = open("Datacard_allyears_M"+str(mass)+"_ech.txt",'w')
...
#    lumi = "lumi     lnN   "
    ...
    for year in sorted(years):
        ...
        bins +=  "   ech_"+year+"   "
        double_bins +=  "   ech_"+year+"   "+"   ech_"+year+"   "
        obs +=    "           -1 "
        if b_multipdf:
        ...
        rates += str(signal_ech_norm[year+"_"+mass])+"   "+str(bkg_ech_norm[year]) + "   "

        rate_sig += str(tot_rate_unc[year][mass]) +"       -    "
        if("2016" in year):
            rate_sig_mu_2016 += str(ech_rate_unc[year][mass]) + "       -    "
            rate_sig_mu_2017 += "   -       -    "
            rate_sig_mu_2018 += "   -       -    "
        if("2017" in year):
            rate_sig_mu_2017 += str(ech_rate_unc[year][mass]) + "       -    "
            rate_sig_mu_2016 += "    -       -    "
            rate_sig_mu_2018 += "   -       -    "
        if("2018" in year):
            rate_sig_mu_2018 += str(ech_rate_unc[year][mass]) + "       -    "
            rate_sig_mu_2016 += "    -       -    "
            rate_sig_mu_2017 += "   -       -    "
