...
for mass in signal_much_norm:
    outputfile = open("Datacard_"+year+"_M"+str(mass)+"_much.txt",'w')
    ...
    outputfile.write("bin               much      much \n")
...
#    outputfile.write("process        MT600       roomultipdf        MT600     roomultipdf \n")
    ...
    outputfile.write("rate    "+str(signal_much_norm[mass])+"   "+str(bkg_much_norm)+" \n \n")
    outputfile.write("------------------------------ \n")
