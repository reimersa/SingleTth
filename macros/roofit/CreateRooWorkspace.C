...
void CreateRooWorkspace::SaveDataAndBkgFunc(defs::Eregion region, defs::Echannel channel, bool dodata, bool all_bkgds, TString year)
{
  ...
  RooRealVar* bgexp2_p0 = new RooRealVar("bgexp2_p0"+ch_name+"_"+year, "bgexp2_p0"+ch_name, 8.2, -1000, 1000);
  RooRealVar* bgexp2_p1 = new RooRealVar("bgexp2_p1"+ch_name+"_"+year, "bgexp2_p1"+ch_name, 4.3, -1000, 1000);
  ...
  infotofile << "bg3p_p0"<<ch_name<<"_"<<year<<"  " << bg3p_p0->getValV() <<"  error  "<< 0.1*bg3p_p0->getError()<<std::endl;
  infotofile << "bg3p_p1"<<ch_name<<"_"<<year<<"   " << bg3p_p1->getValV() <<"  error  "<< 0.1*bg3p_p1->getError()<<std::endl;
  infotofile << "bg3p_p2"<<ch_name<<"_"<<year<<"   " << bg3p_p2->getValV() <<"  error  "<< 0.1*bg3p_p2->getError()<<std::endl;
