...
ClassImp(SignalDoubleGauss_M600); 
  
SignalDoubleGauss_M600::SignalDoubleGauss_M600(const char *name, const char *title, 
				   RooAbsReal& _x,
				   RooAbsReal& _p0,
				   RooAbsReal& _p1) :
...
SignalDoubleGauss_M600::SignalDoubleGauss_M600(const SignalDoubleGauss_M600& other, const char* name) :  
...
Double_t SignalDoubleGauss_M600::evaluate() const 
{ 
